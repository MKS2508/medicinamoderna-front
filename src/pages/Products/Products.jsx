...
const Products = (props) => {
    ...
    const [page, setActivePage] = useState(0);
    ...
    const initializePage = (pageParam) => {
        setProducts(getProducts(props.ProductsProps.id, pageParam));
    }
    ...
    return (<>
        <div className="center">
            <div className="title">
                <h1>CATALOGO DE {props.ProductsProps.name}</h1>
                <h2>Aqui puedes encontrar lo relacionado con papeles, mecheros, grinders...</h2>
            </div>
